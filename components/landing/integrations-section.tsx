...
function IntegrationCard({ item }: { item: Integration }) {
  ...
  return (
    <div className="group flex h-[92px] w-52 shrink-0 flex-col justify-center border border-foreground/10 px-8 transition-all duration-300 hover:border-foreground/30 hover:bg-foreground/[0.02]">
      {/* Фиксированная высота карточки: логотип и название занимают разное
          место, и без неё карточки в бегущей строке скакали бы по высоте. */}
