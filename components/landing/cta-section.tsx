...
const LEAD_FLOWS = [
  ...
  { d: "M-40 64C440 82 255 10 820 10", op: 0.22, dur: "12.5s", delay: "-4.1s" },
  { d: "M-30 100C450 116 295 16 820 16", op: 0.16, dur: "8.5s", delay: "-2.6s" },
  { d: "M40 130C470 142 345 22 820 22", op: 0.12, dur: "11s", delay: "-6.2s" },
  { d: "M240 154C560 152 455 27 820 27", op: 0.1, dur: "10s", delay: "-7.4s" },
];
...
function LeadFlows() {
  return (
    <svg
      ...
      fill="none"
      aria-hidden="true"
      className="pointer-events-none absolute right-full top-1/2 -mt-1 hidden h-[150px] w-[820px] select-none lg:block"
    >
      <style>{`
        .lf-pulse {
          fill: none;
