 ...
 * высоту левой кромки кнопки (6…26 — нижняя половина её 56px).
 */
const LEAD_FLOWS = [
  { d: "M-40 38C440 62 220 6 820 6", op: 0.2, dur: "9.5s", delay: "-1.2s" },
  { d: "M-50 112C450 132 270 14 820 14", op: 0.22, dur: "12.5s", delay: "-4.1s" },
  { d: "M-30 194C460 208 320 20 820 20", op: 0.16, dur: "8.5s", delay: "-2.6s" },
  { d: "M150 272C540 258 400 26 820 26", op: 0.12, dur: "11s", delay: "-6.2s" },
  { d: "M420 276C670 252 510 10 820 10", op: 0.1, dur: "10s", delay: "-7.4s" },
];
...
function LeadFlows() {
  return (
    <svg
      ...
      fill="none"
      aria-hidden="true"
      className="pointer-events-none absolute right-full top-1/2 -mt-1 hidden h-[240px] w-[820px] select-none lg:block"
    >
      <style>{`
        .lf-pulse {
          fill: none;
